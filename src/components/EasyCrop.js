			...
			<div className="toolbox-container">
				<div className="toolbox" style={{display:"flex"}}>
					<div className="btn-group">
						...
						{props.toolbar.rotateanticlockwise?<button className="btn btn-sm btn-default" onClick={rotateAntiRight} title={props.renderIcons?props.translations.rotateanticlockwise:""}>{props.renderIcons?<span className={props.icons.rotateanticlockwise!=null?props.icons.rotateanticlockwise:"glyphicon glyphicon-refresh icon-flipped"} aria-hidden="true"></span>:props.translations.rotateanticlockwise}</button>:null}
